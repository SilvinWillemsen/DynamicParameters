...
//        Fn = clamp(val, 0, 10);
    ...
    void updateGrid (double val);
    void fullGridInterpolation (int Ngoal, bool smooth = false);
...
private:
    double fs, freq, c, L, T, Eyoung, Iner, r, csA, rho, k, kHalf, s0, s1, B, kappa, h, muSq, kOh, gOh, a, BM, tol, q, qPrev, qPrevIt, b, eps, fp, B1, B2, b1, b2, A1, A1ss, A2, A3, A4, A5, D, E;
    ...
    double rOCkinEnergy = 0;
    double rOCpotEnergy = 0;
    double rOCdmpEnergy = 0;
    double rOCbowEnergy = 0;
    double rOCenergy = 0;
